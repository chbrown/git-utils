...
def main():
    ...
    parser_commits.add_argument('-o', '--owner', help='repository owner (user/organization)')
    ...
    parser_contents.add_argument('-o', '--owner', help='repository owner (user/organization)')
    ...
    parser_contents.add_argument('-o', '--owner', help='repository owner (user/organization)')
    parser_contents.add_argument('-r', '--repo', help='repository name')
    parser_contents.add_argument('-p', '--path', help='path in repository to list contents of')
